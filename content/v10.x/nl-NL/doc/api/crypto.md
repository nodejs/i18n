...
* `buffer` {Buffer}
* `opties` {Object} [`stream.transform` options][] 
...
> Stabiliteit: 0 - Afgekeurd: Gebruik als alternatief [`crypto.createCipheriv()`][].
...
> Stabiliteit: 0 - Afgekeurd: Gebruik als alternatief [`crypto.createDecipheriv()`][].
