...
<ul>
  <li>
    <code>opties</code> {Object} Available options are: <ul>
      <li>
      ...
      <li>
        <code>allowHalfOpen</code> {boolean} Indicates whether half-opened TCP connections are allowed. See [<code>net.createServer()</code>][] and the [<code>'end'</code>][] event for details. <strong>Standaard:</strong> <code>false</code>.
      </li>
      <li>
        <code>readable</code> {boolean} Allow reads on the socket when an <code>fd</code> is passed, otherwise ignored. <strong>Standaard:</strong> <code>false</code>.
      </li>
      <li>
        <code>writable</code> {boolean} Allow writes on the socket when an <code>fd</code> is passed, otherwise ignored. <strong>Standaard:</strong> <code>false</code>.
      </li>
    </ul>
  </li>
  <li>
...
<ul>
  ...
  <li>
    <code>encoding</code> {string} Only used when data is <code>string</code>. <strong>Standaard:</strong> <code>'utf8'</code>.
  </li>
  <li>
...
<ul>
  <li>
    <code>opties</code> {Object} <ul>
      <li>
        <code>allowHalfOpen</code> {boolean} Indicates whether half-opened TCP connections are allowed. <strong>Standaard:</strong> <code>false</code>.
      </li>
      <li>
        <code>pauseOnConnect</code> {boolean} Indicates whether the socket should be paused on incoming connections. <strong>Standaard:</strong> <code>false</code>.
      </li>
    </ul>
  </li>
  <li>
