...
* Review a bit at a time. Do not overwhelm new contributors.
  * It is tempting to micro-optimize. Don't succumb to that temptation. Мы часто меняем V8. Techniques that provide improved performance today may be unnecessary in the future.
