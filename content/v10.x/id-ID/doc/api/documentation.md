...
Indeks stabilitas adalah sebagai berikut:

> Stabilitas: 0 - Usang. The feature may emit warnings. Backward compatibility is not guaranteed.

<!-- separator -->

> Stabilitas: 1 - Eksperimental. This feature is still under active development and subject to non-backward compatible changes or removal in any future version. Penggunaan fitur ini tidak disarankan dalam lingkungan produksi. Experimental features are not subject to the Node.js Semantic Versioning model.

<!-- separator -->

> Stabilitas: 2 - Stabil. Compatibility with the npm ecosystem is a high priority.
