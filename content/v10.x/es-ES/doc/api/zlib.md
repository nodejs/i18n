...
Each zlib-based class takes an `options` object. Todas las opciones son opcionales.
...
Each Brotli-based class takes an `options` object. Todas las opciones son opcionales.
