...
N-API proporciona métodos para crear referencias persistentes a un objeto. Cada referencia persistente tiene una cuenta asociada con un valor de 0 o superior. La cuenta determina si la referencia mantendrá vivo al objeto correspondiente. References with a count of 0 do not prevent the object from being collected and are often called 'weak' references. Any count greater than 0 will prevent the object from being collected.
