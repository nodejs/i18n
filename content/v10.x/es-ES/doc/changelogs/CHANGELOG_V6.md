...
* **v8_inspector**: Generar un UUID para cada ejecución del inspector. Esto provee seguridad adicional para prevenir que clientes no autorizados se conecten al proceso de Node.js por medio del puerto de v8_inspector cuando se ejecute con `--inspect`. Ya que el protocolo de depuración permite acceso extenso a elementos internos de un proceso en ejecución, y la ejecución de código arbitrario, es importante limitar conexiones a solo herramientas autorizadas. Vulnerabilidad originalmente reportada por Jann Horn. (Eugene Ostroukhov)
