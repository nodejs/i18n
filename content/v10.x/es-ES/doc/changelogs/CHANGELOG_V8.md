...
* **Espacios rechazados en los valores de encabezado HTTP `Content-Length` (CVE-2018-7159)**: El analizador HTTP Node.js permitió espacios dentro de valores de encabezado `Content-Length`. Tales valores conducen ahora a conexiones rechazadas de la misma manera que los valores no numéricos.
