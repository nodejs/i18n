...
* **node**: Reparar `process.release.libUrl` fallido en Windows (Rod Vagg) [#2699](https://github.com/nodejs/node/pull/2699)
* **node-gyp**: Hacer float a v3.0.3, la cual tiene soporte mejorado para Node.js e io.js desde v0.10 hasta v4+ (Rod Vagg) [#2700](https://github.com/nodejs/node/pull/2700)
...
* [[`5a51edd718`](https://github.com/nodejs/node/commit/5a51edd718)] - **build**: añadir --enable-asan con revisión de fugas incorporada (Karl Skomski) [#2376](https://github.com/nodejs/node/pull/2376)
...
* [[`e68c7ec498`](https://github.com/nodejs/node/commit/e68c7ec498)] - **contextify**: ignorar a los getters durante la inicialización (Fedor Indutny) [nodejs/io.js#2091](https://github.com/nodejs/io.js/pull/2091)
...
* [[`4cf225daad`](https://github.com/nodejs/node/commit/4cf225daad)] - **deps**: hacer float a node-gyp v3.0.0 (Rod Vagg) [#2700](https://github.com/nodejs/node/pull/2700)
...
* [[`4593539b92`](https://github.com/nodejs/node/commit/4593539b92)] - **deps**: hacer backport a 75e43a6 desde upstream de v8 (saper) [#2636](https://github.com/nodejs/node/pull/2636)
...
* [[`4fdccb9eb7`](https://github.com/nodejs/node/commit/4fdccb9eb7)] - **doc**: corregir unión de comas en el doc "Assertion Testing" (Rich Trott) [#2728](https://github.com/nodejs/node/pull/2728)
* [[`28c2d310d6`](https://github.com/nodejs/node/commit/28c2d310d6)] - **doc**: actualizar la lista AUTHORS (Rod Vagg)
* [[`324c073fb9`](https://github.com/nodejs/node/commit/324c073fb9)] - **doc**: añadir minutas de la reunión del TSC el 2015-09-02 (Rod Vagg) [#2674](https://github.com/nodejs/node/pull/2674)
* [[`8929445686`](https://github.com/nodejs/node/commit/8929445686)] - **doc**: actualizar el doc de url para que informe sobre los escapes (Jeremiah Senkpiel) [#2605](https://github.com/nodejs/node/pull/2605)
...
* [[`7f7d4fdddd`](https://github.com/nodejs/node/commit/7f7d4fdddd)] - **node-gyp**: hacer float a 3.0.1, pequeña corrección para el url de descarga (Rod Vagg) [#2737](https://github.com/nodejs/node/pull/2737)
...
* [[`ac98e13b95`](https://github.com/nodejs/node/commit/ac98e13b95)] - **src**: s/ia32/x86 para process.release.libUrl para win (Rod Vagg) [#2699](https://github.com/nodejs/node/pull/2699)
* [[`ca6c3223e1`](https://github.com/nodejs/node/commit/ca6c3223e1)] - **src**: usar conformación de snprintf estándar en windows (Karl Skomski) [#2404](https://github.com/nodejs/node/pull/2404)
* [[`b028978a53`](https://github.com/nodejs/node/commit/b028978a53)] - **src**: corregir desbordamiento de buffer para líneas de excepción largas (Karl Skomski) [#2404](https://github.com/nodejs/node/pull/2404)
...
* [[`ed087836af`](https://github.com/nodejs/node/commit/ed087836af)] - **streams**: refactorizar LazyTransform a internal/ (Brendan Ashworth) [#2566](https://github.com/nodejs/node/pull/2566)
...
* [[`f3d5891a3f`](https://github.com/nodejs/node/commit/f3d5891a3f)] - **test**: esperar error de test_lookup_ipv6_hint en FreeBSD (Rich Trott) [#2724](https://github.com/nodejs/node/pull/2724)
...
* [[`b2c5479a14`](https://github.com/nodejs/node/commit/b2c5479a14)] - **test**: refactorizar para eliminar prueba defectuosa (Rich Trott) [#2609](https://github.com/nodejs/node/pull/2609)
* [[`fcfd15f8f9`](https://github.com/nodejs/node/commit/fcfd15f8f9)] - **test**: marcar eval_messages como defectuosa (Alexis Campailla) [#2648](https://github.com/nodejs/node/pull/2648)
* [[`1865cad7ae`](https://github.com/nodejs/node/commit/1865cad7ae)] - **test**: marcar test-vm-syntax-error-stderr como defectuosa (João Reis) [#2662](https://github.com/nodejs/node/pull/2662)
* [[`b0014ecd27`](https://github.com/nodejs/node/commit/b0014ecd27)] - **test**: marcar test-repl-persistent-history como defectuosa (João Reis) [#2659](https://github.com/nodejs/node/pull/2659)
...
* [[`5d14a6eca7`](https://github.com/nodejs/node/commit/5d14a6eca7)] - **timers**: no mutar la lista de "sin referencias" al iterarla (Julien Gilli) [#2540](https://github.com/nodejs/node/pull/2540)
...
* [[`07fbf835ad`](https://github.com/nodejs/node/commit/07fbf835ad)] - **tools**: abrir el archivo de `test.tap` en el modo de escritura binaria (Sakthipriyan Vairamani) [#2837](https://github.com/nodejs/node/pull/2837)
* [[`6d9198f7f1`](https://github.com/nodejs/node/commit/6d9198f7f1)] - **tools**: añadir el polyfill faltante del procesador de ticks (Matt Loring) [#2694](https://github.com/nodejs/node/pull/2694)
* [[`7b16597527`](https://github.com/nodejs/node/commit/7b16597527)] - **tools**: corregir defectuosidad en test-tick-processor (Matt Loring) [#2694](https://github.com/nodejs/node/pull/2694)
* [[`ef83029356`](https://github.com/nodejs/node/commit/ef83029356)] - **tools**: remover hyphen en resultado de TAP (Sakthipriyan Vairamani) [#2718](https://github.com/nodejs/node/pull/2718)
...
* **http_parser**: Una mejora significa en el rendimiento al hacer que `http.Server` consuma todos los datos iniciales desde su `net.Socket` y los analice directamente sin tener que ingresar a JavaScript. El uso de listeners de `'data'` en el `net.Socket` causará que los datos sean "desconsumidos" en JavaScript, deshaciendo, por ende, cualquier ganancia obtenida para el rendimiento. (Fedor Indutny) [#2355](https://github.com/nodejs/node/pull/2355)
...
* [[`5fef5c6562`](https://github.com/nodejs/node/commit/5fef5c6562)] - **(SEMVER-MINOR)** **tls**: añadir interruptor de la línea de comandos --tls-cipher-list (James M Snell) [#2412](https://github.com/nodejs/node/pull/2412)
...
* **crypto**: 
  ...
  * El inicio de sesión ahora revisa en busca de errores de OpenSSL (Minqi Pan) [#2342](https://github.com/nodejs/node/pull/2342). **Note que esto puede exponer errores previos ocultos en el código de usuario.**
* **intl**: el soporte de Intl utilizando small-icu ahora se encuentra predeterminadamente habilitado en las compilaciones (Steven R. Loomis) [#2264](https://github.com/nodejs/node/pull/2264). 
...
* **herramientas**: El procesador de ticks de v8 ahora viene empaquetado con node (Matt Loring) [#2090](https://github.com/nodejs/node/pull/2090). 
...
* [[`fb0f5d733f`](https://github.com/nodejs/node/commit/fb0f5d733f)] - **(SEMVER-MINOR)** **tools**: ejecutar el procesador de ticks sin compilar v8 (Matt Loring) [#2090](https://github.com/nodejs/node/pull/2090)
...
* **v8**: Actualizado a 4.4.63.26 
  ...
  * Introducción de la API de C++ de `Maybe` y `MaybeLocal` para objetos que *pueden* o *no* tener un valor.
...
* [[`ef2c8cd4ec`](https://github.com/nodejs/node/commit/ef2c8cd4ec)] - **(SEMVER-MAJOR)** **dgram**: hacer que el envío de de cb funcione como un manejador de eventos de "error" (Matteo Collina) [#1796](https://github.com/nodejs/node/pull/1796)
* [[`3da057fef6`](https://github.com/nodejs/node/commit/3da057fef6)] - **(SEMVER-MAJOR)** **dgram**: hacer que el envío de de cb funcione como un manejador de eventos de "error" (Chris Dickinson) [#1796](https://github.com/nodejs/node/pull/1796)
...
* [[`ed6c249104`](https://github.com/nodejs/node/commit/ed6c249104)] - **(SEMVER-MAJOR)** **repl**: historial persistente en texto sin formato (Jeremiah Senkpiel) [#2224](https://github.com/nodejs/node/pull/2224)
* [[`f7d5e4c618`](https://github.com/nodejs/node/commit/f7d5e4c618)] - **(SEMVER-MINOR)** **repl**: persistencia por defecto en ~/.node_repl_history (Jeremiah Senkpiel) [#2224](https://github.com/nodejs/node/pull/2224)
...
* [[`66fc8ca22b`](https://github.com/nodejs/node/commit/66fc8ca22b)] - **(SEMVER-MINOR)** **cluster**: emitir evento 'message' en el máster del clúster (Sam Roberts) [#861](https://github.com/nodejs/node/pull/861)
...
* [[`fef87fee1d`](https://github.com/nodejs/node/commit/fef87fee1d)] - **(SEMVER-MINOR)** **lib,test**: añadir desaprobación y prueba de la "freelist" (Sakthipriyan Vairamani) [#2176](https://github.com/nodejs/node/pull/2176)
...
* **libuv**: Actualizado a 1.6.0 y 1.6.1, vea [full ChangeLog](https://github.com/libuv/libuv/blob/60e515d9e6f3d86c0eedad583805201f32ea3aed/ChangeLog#L1-L36) para detalles. (Saúl Ibarra Corretgé) [#1905](https://github.com/nodejs/node/pull/1905) [#1889](https://github.com/nodejs/node/pull/1889). Destacan: 
...
* [[`353e26e3c7`](https://github.com/nodejs/node/commit/353e26e3c7)] - **(SEMVER-MINOR)** **fs**: Añadir opción de codificación de strings para el método de Stream (Yosuke Furukawa) [#1845](https://github.com/nodejs/node/pull/1845)
...
* [[`5b6f575c1f`](https://github.com/nodejs/node/commit/5b6f575c1f)] - ***Revertir*** "**src**: añadir el analizador de opciones de getopt" (Evan Lucas) [#1862](https://github.com/nodejs/node/pull/1862)
...
* **npm**: npm fue actualizado a v2.11.0. Nuevos hooks para los eventos del ciclo de vida de `preversion`, `version`, y `postversion`, algunos cambios de licencia relacionados con SPDX e inclusiones de archivos de licencia. Vea las [notas de lanzamiento](https://github.com/npm/npm/releases/tag/v2.11.0) para detalles completos.
...
* [[`3a1bc067d4`](https://github.com/nodejs/node/commit/3a1bc067d4)] - ***Revert*** "**core**: establecer el tipo PROVIDER como un identificador de la clase Persistent" (Ben Noordhuis) [#1827](https://github.com/nodejs/node/pull/1827)
...
* **crypto**: Los parámetros del intercambio de claves Diffie-Hellman (DHE) (`'dhparams'`) ahora deben ser de 1024 o más bits, o se arrojará un error. También se imprimirá una advertencia en la consola si suministra menos de 2048 bits. Vea https://weakdh.org/ para un mayor contexto de este asunto de seguridad. (Shigeki Ohtsu) [#1739](https://github.com/nodejs/node/pull/1739).
...
* **util**: Un incremento significativo en la velocidad (alrededor del 35%) para el caso común del paso de un argumento de una sola string a `util.format()`, utilizado por `console.log()` (Сковорода Никита Андреевич) [#1749](https://github.com/nodejs/node/pull/1749).
...
* [[`2b1c01c2cc`](https://github.com/nodejs/node/commit/2b1c01c2cc)] - **build**: refactorizar pkg-config para las librerías compartidas (Johan Bergström) [#1603](https://github.com/nodejs/node/pull/1603)
* [[`3c44100558`](https://github.com/nodejs/node/commit/3c44100558)] - **core**: establecer la clase "PROVIDER" como un id de la clase "Persistent" (Trevor Norris) [#1730](https://github.com/nodejs/node/pull/1730)
* [[`c1de6d249e`](https://github.com/nodejs/node/commit/c1de6d249e)] - **(SEMVER-MINOR)** **core**: implementar bandera del tiempo de ejecución para hacer seguimiento a io sincrónica (Trevor Norris) [#1707](https://github.com/nodejs/node/pull/1707)
...
* [[`85d9983009`](https://github.com/nodejs/node/commit/85d9983009)] - **net**: opciones de persist net.Socket antes de conectar (Evan Lucas) [#1518](https://github.com/nodejs/node/pull/1518)
* [[`39dde3222e`](https://github.com/nodejs/node/commit/39dde3222e)] - **(SEMVER-MINOR)** **net,dgram**: devolver esto desde los métodos con y sin referencias (Roman Reiss) [#1768](https://github.com/nodejs/node/pull/1768)
...
* [[`f29762f4dd`](https://github.com/nodejs/node/commit/f29762f4dd)] - **test**: habilitar lint para las pruebas (Roman Reiss) [#1721](https://github.com/nodejs/node/pull/1721)
...
* [[`214d02040e`](https://github.com/nodejs/node/commit/214d02040e)] - **util**: acelerar caso común de string de formato (Сковорода Никита Андреевич) [#1749](https://github.com/nodejs/node/pull/1749)
* [[`d144e96fbf`](https://github.com/nodejs/node/commit/d144e96fbf)] - **win,node-gyp**: habilitar por defecto el hook delay-load (Bert Belder) [#1763](https://github.com/nodejs/node/pull/1763)
* [[`0d6d3dda95`](https://github.com/nodejs/node/commit/0d6d3dda95)] - **win,node-gyp**: hacer que el hook delay-load cumpla con C89 (Sharat M R) [TooTallNate/node-gyp#616](https://github.com/TooTallNate/node-gyp/pull/616)
...
* **async_wrap**: (Trevor Norris) [#1614](https://github.com/nodejs/node/pull/1614) 
  ...
  * *tenga en cuenta que esta es una API inestable, por lo que la adición de funciones y los cambios de ruptura no cambiarán el semver de io.js*
...
* [[`1bef717476`](https://github.com/nodejs/node/commit/1bef717476)] - **(SEMVER-MINOR)** **net**: limpiar la lógica de "connect" (Evan Lucas) [#1505](https://github.com/nodejs/node/pull/1505)
...
* [[`b57cc51d8d`](https://github.com/nodejs/node/commit/b57cc51d8d)] - **(SEMVER-MAJOR)** **os**: remover barra diagonal final de os.tmpdir() (Christian Tellnes) [#747](https://github.com/nodejs/node/pull/747)
...
* [[`c1b9913e1f`](https://github.com/nodejs/node/commit/c1b9913e1f)] - **(SEMVER-MAJOR)** **src**: actualizar NODE_MODULE_VERSION según la API de V8 (Rod Vagg) [#1532](https://github.com/nodejs/node/pull/1532)
...
* [[`0daed24883`](https://github.com/nodejs/node/commit/0daed24883)] - ***Revertir*** "**url**: borrar la caché de href en todas las rutas de código de setters" (Rod Vagg) [#1602](https://github.com/nodejs/node/pull/1602)
* [[`0f39ef4ca1`](https://github.com/nodejs/node/commit/0f39ef4ca1)] - ***Revertir*** "**url**: corregir el trato de algunos valores como no-vacíos" (Rod Vagg) [#1602](https://github.com/nodejs/node/pull/1602)
...
* [[`3bda6cbfa4`](https://github.com/nodejs/node/commit/3bda6cbfa4)] - **(SEMVER-MAJOR)** **win,node-gyp**: habilitar por defecto el hook delay-load (Bert Belder) [#1433](https://github.com/nodejs/node/pull/1433)
...
* [[`53ed89d927`](https://github.com/nodejs/node/commit/53ed89d927)] - ***Revertir*** "**build**: utilizar %PYTHON% en lugar de python" (Rod Vagg) [#1475](https://github.com/nodejs/node/pull/1475)
...
* [[`3ad82c335d`](https://github.com/nodejs/node/commit/3ad82c335d)] - **(SEMVER-MINOR)** **module**: manejar NODE_PATH en require('.') (Roman Reiss) [#1363](https://github.com/nodejs/node/pull/1363)
...
* [[`10e31ba56c`](https://github.com/nodejs/node/commit/10e31ba56c)] - **(SEMVER-MINOR)** **node**: permitir argumentos múltiples pasados a nextTick (Trevor Norris) [#1077](https://github.com/nodejs/node/pull/1077)
...
* **C++ API**: Fedor Indutny contribuyó a V8 en una función, a la cual se le ha hecho backport al V8 incluido en io.js. `SealHandleScope` permite a un autor de complementos de C++ *sellar* un `HandleScope` para evitar más asignaciones no deseadas. Actualmente solo está habilitado para builds de depuración de io.js. Esta función ayudó a detectar la fuga en [#1075](https://github.com/nodejs/node/issues/1075) y ahora se encuentra habilitada en el `HandleScope` raíz en io.js. (Fedor Indutny) [#1395](https://github.com/nodejs/node/pull/1395).
* **ARM**: Este lanzamiento incluye un trabajo significativo para mejorar el estado del soporte de ARM para compilaciones y pruebas. Los servidores de los builds de ARMv6, ARMv7 y ARMv8 del clúster de CI de io.js están (casi todos) reportando las compilaciones y pruebas exitosas. 
...
* [[`a5244d3a39`](https://github.com/nodejs/node/commit/a5244d3a39)] - **(SEMVER-MINOR)** **deps**: hacer backport a 1f8555 desde upstream de v8 (Fedor Indutny) [#1395](https://github.com/nodejs/node/pull/1395)
...
* [[`a07c69113a`](https://github.com/nodejs/node/commit/a07c69113a)] - **(SEMVER-MINOR)** **src**: usar SealHandleScope global (Fedor Indutny) [#1395](https://github.com/nodejs/node/pull/1395)
...
* [[`48d69cf1bb`](https://github.com/io.js/io.js/commit/48d69cf1bb)] - ***Revert*** "**doc**: corregir error tipográfico en CHANGELOG.md" (Giovanny Andres Gongora Granada) [iojs/io.js#1349](https://github.com/nodejs/node/pull/1349)
* [[`679596c848`](https://github.com/io.js/io.js/commit/679596c848)] - **doc**: añadir Docker WG (Peter Petrov) [iojs/io.js#1134](https://github.com/nodejs/node/pull/1134)
...
* [[`8c6c376a94`](https://github.com/io.js/io.js/commit/8c6c376a94)] - **doc**: añadir huella dactilar GPG para Fishrock123 (Jeremiah Senkpiel) [iojs/io.js#1324](https://github.com/nodejs/node/pull/1324)
...
* [[`4dc6ae2181`](https://github.com/io.js/io.js/commit/4dc6ae2181)] - **lib**: eliminar las variables sin utilizar (Brian White) [iojs/io.js#1290](https://github.com/nodejs/node/pull/1290)
...
* [[`416499c872`](https://github.com/io.js/io.js/commit/416499c872)] - **timers**: eliminar código redundante (Fedor Indutny) [iojs/io.js#1330](https://github.com/nodejs/node/pull/1330)
* [[`d22b2a934a`](https://github.com/io.js/io.js/commit/d22b2a934a)] - **timers**: no reiniciar el intervalo después de cerrar (Fedor Indutny) [iojs/io.js#1330](https://github.com/nodejs/node/pull/1330)
...
* [[`0e061975d7`](https://github.com/io.js/io.js/commit/0e061975d7)] - **timers**: corregir la pérdida de memoria de unref() (Trevor Norris) [iojs/io.js#1330](https://github.com/nodejs/node/pull/1330)
* [[`ec7fbf2bb2`](https://github.com/io.js/io.js/commit/ec7fbf2bb2)] - **tools**: corregir la ruta de fuente de instalación para openssl headers (Oguz Bastemur) [iojs/io.js#1354](https://github.com/nodejs/node/pull/1354)
* [[`644ece1f67`](https://github.com/io.js/io.js/commit/644ece1f67)] - **tools**: eliminar el directorio de la prueba de gyp (Shigeki Ohtsu) [iojs/io.js#1350](https://github.com/nodejs/node/pull/1350)
...
* **timers**: dos problemas menores con los temporizadores han sido corregidos: 
  * `Timer#close()` ahora es idempotente [#1288](https://github.com/nodejs/node/issues/1288) (Petka Antonov).
  * `setTimeout()` sólo ejecutará el callback una vez después de un `unref()` durante el callback [#1231](https://github.com/nodejs/node/pull/1231) (Roman Reiss).
  * NOTA: todavía hay otros asuntos por resolver con el código de los temporizadores, como [#1152](https://github.com/nodejs/node/pull/1152).
...
* **npm**: actualización de npm a 2.7.4. Vea [npm CHANGELOG.md](https://github.com/npm/npm/blob/master/CHANGELOG.md#v274-2015-03-20) para detalles. Resumen: 
  * [`1549106`](https://github.com/npm/npm/commit/1549106f518000633915686f5f1ccc6afcf77f8f) [#7641](https://github.com/npm/npm/issues/7641) Debido a 448efd0, la ejecución de `npm shrinkwrap --dev` causó que las dependencias de producción ya no fueran incluidas en `npm-shrinkwrap.json`. ¡Ooops! ([@othiym23](https://github.com/othiym23))
  * [`fb0ac26`](https://github.com/npm/npm/commit/fb0ac26eecdd76f6eaa4a96a865b7c6f52ce5aa5) [#7579](https://github.com/npm/npm/issues/7579) Solo bloquear los enlaces y archivos de eliminación cuando estemos seguros de que el npm no sea responsable de ellos. Este cambio es difícil de resumir, ya que si las cosas están funcionando correctamente usted no debería notarlo, pero si desea más contexto solo [lea el mensaje del commit](https://github.com/npm/npm/commit/fb0ac26eecdd76f6eaa4a96a865b7c6f52ce5aa5), en el que todo se explica. ([@othiym23](https://github.com/othiym23))
  * [`051c473`](https://github.com/npm/npm/commit/051c4738486a826300f205b71590781ce7744f01) [#7552](https://github.com/npm/npm/issues/7552) `bundledDependencies` ahora están adecuadamente incluidas en el contexto de instalación. Este es otro bug increíblemente difícil de resumir, y una vez más, le animo a [leer el mensaje de compromiso](https://github.com/npm/npm/commit/051c4738486a826300f205b71590781ce7744f01) si tiene curiosidad acerca de los detalles. Un breve resumen es que esto corrige muchos casos de uso para `ember-cli`. ([@othiym23](https://github.com/othiym23))
  ...
  * [`89ce829`](https://github.com/npm/npm/commit/89ce829a00b526d0518f5cd855c323bffe182af0)[#7630](https://github.com/npm/npm/issues/7630) `hosted-git-info@1.5.3`: Parte 3 de asegurar que la taquigrafía de Github se maneja constantemente. ([@othiym23](https://github.com/othiym23))
  * [`63313eb`](https://github.com/npm/npm/commit/63313eb0c37891c355546fd1093010c8a0c3cd81)[#7630](https://github.com/npm/npm/issues/7630) `realize-package-specifier@2.2.0`: Parte 2 de asegurar que la taquigrafía de Github se maneja constantemente. ([@othiym23](https://github.com/othiym23))
  * [`3ed41bf`](https://github.com/npm/npm/commit/3ed41bf64a1bb752bb3155c74dd6ffbbd28c89c9)[#7630](https://github.com/npm/npm/issues/7630) `npm-package-arg@3.1.1`: Parte 3 de asegurar que la taquigrafía de Github se maneja constantemente. ([@othiym23](https://github.com/othiym23))
...
* [[`a2ea16838f`](https://github.com/nodejs/node/commit/a2ea16838f)] - **debugger**: no generar procesos secundarios en el modo remoto (Jackson Tian) [#1282](https://github.com/nodejs/node/pull/1282)
...
* [[`5e609e9324`](https://github.com/nodejs/node/commit/5e609e9324)] - ***Revertir*** "**doc**: clarificar el requerimiento de nombre real" (Jeremiah Senkpiel) [#1276](https://github.com/nodejs/node/pull/1276)
...
* [[`c9207f7fc2`](https://github.com/nodejs/node/commit/c9207f7fc2)] - **fs**: corregir la corrupción en writeFile y writeFileSync (Olov Lassus) [#1063](https://github.com/nodejs/node/pull/1063)
...
* [[`c8fa8ccdbc`](https://github.com/nodejs/node/commit/c8fa8ccdbc)] - **streams**: utilizar strict en _stream_wrap (Brendan Ashworth) [#1279](https://github.com/nodejs/node/pull/1279)
...
* [[`77c2da10fd`](https://github.com/nodejs/node/commit/77c2da10fd)] - **timers**: hacer a Timer.close idempotente (Petka Antonov) [#1288](https://github.com/nodejs/node/pull/1288)
...
* [[`caf0b36de3`](https://github.com/nodejs/node/commit/caf0b36de3)] - **timers**: asegurar que el callback de setTimeout solo se ejecute una vez (Roman Reiss) [#1231](https://github.com/nodejs/node/pull/1231)
* [[`2ccc8f3970`](https://github.com/nodejs/node/commit/2ccc8f3970)] - **tls_wrap**: corregir esta increíblemente estúpida fuga (Fedor Indutny) [#1244](https://github.com/nodejs/node/pull/1244)
...
* [[`ba93c583bc`](https://github.com/nodejs/node/commit/ba93c583bc)] - **win,node-gyp**: permitir que opcionalmente se pueda renombrar a node.exe/iojs.exe (Bert Belder) [#1266](https://github.com/nodejs/node/pull/1266)
...
* [[`bc9c1a5a7b`](https://github.com/nodejs/node/commit/bc9c1a5a7b)] - **doc**: corregir error tipográfico en CHANGELOG (Mathieu Darse) [#1230](https://github.com/nodejs/node/pull/1230)
* [[`99c79f8d41`](https://github.com/nodejs/node/commit/99c79f8d41)] - **doc**: llamar a la función js en el contexto nulo (Ben Noordhuis) [#1125](https://github.com/nodejs/node/pull/1125)
...
* [[`c4e1b82120`](https://github.com/nodejs/node/commit/c4e1b82120)] - **doc**: remplazar v8::Handle<t> con v8::Local<t> (Ben Noordhuis) [#1125](https://github.com/nodejs/node/pull/1125)
* [[`2f1b78347c`](https://github.com/nodejs/node/commit/2f1b78347c)] - **doc**: eliminar los v8::HandleScopes innecesarios (Ben Noordhuis) [#1125](https://github.com/nodejs/node/pull/1125)
* [[`409d413363`](https://github.com/nodejs/node/commit/409d413363)] - **doc**: eliminar los usos de v8::Isolate::GetCurrent() (Ben Noordhuis) [#1125](https://github.com/nodejs/node/pull/1125)
...
* [[`b64983d77c`](https://github.com/nodejs/node/commit/b64983d77c)] - **src**: reiniciar el manejador de señal a SIG_DFL en FreeBSD (Fedor Indutny) [#1218](https://github.com/nodejs/node/pull/1218)
* [[`9705a34e96`](https://github.com/nodejs/node/commit/9705a34e96)] - **test**: mover sequential/test-signal-unregister (Ben Noordhuis) [#1227](https://github.com/nodejs/node/pull/1227)
...
* [[`4c731042d4`](https://github.com/nodejs/node/commit/4c731042d4)] - **configure**: utilizar cc y c++ como predeterminados en os x (Ben Noordhuis) [#1210](https://github.com/nodejs/node/pull/1210)
...
* [[`c9aec2b716`](https://github.com/nodejs/node/commit/c9aec2b716)] - **querystring**: corregir el stringifyPrimitive roto (Jeremiah Senkpiel) [#1213](https://github.com/nodejs/node/pull/1213)
* [[`a89f5c2156`](https://github.com/nodejs/node/commit/a89f5c2156)] - **querystring**: analizar los números correctamente (Jeremiah Senkpiel) [#1213](https://github.com/nodejs/node/pull/1213)
...
* **node**: a new `-r` or `--require` la opción command-line puede ser utilizada para pre-cargar módulos en el inicio (Ali Ijaz Sheikh) [#881](https://github.com/nodejs/node/pull/881).
* **querystring**: `parse()` y `stringify()` ahora son más veloces (Brian White) [#847](https://github.com/nodejs/node/pull/847).
...
* **platforms**: ahora el sistema de integración continua de io.js reporta los pases a **FreeBSD** y **SmartOS** (*Solaris*).
* **npm**: actualización de npm a 2.7.1. Vea [npm CHANGELOG.md](https://github.com/npm/npm/blob/master/CHANGELOG.md#v271-2015-03-05) para detalles. Resumen: 
...
* [[`3bc445f6c2`](https://github.com/nodejs/node/commit/3bc445f6c2)] - **doc**: corregir un enlace de github de colaborador roto (Aleksanteri Negru-Vode) [#1204](https://github.com/nodejs/node/pull/1204)
* [[`813a536126`](https://github.com/nodejs/node/commit/813a536126)] - **buffer**: eliminación de código duplicado (Thorsten Lorenz) [#1144](https://github.com/nodejs/node/pull/1144)
* [[`1514b82355`](https://github.com/nodejs/node/commit/1514b82355)] - **(SEMVER-MINOR) src**: añadir banderas de -r/--require para módulos de pre-carga (Ali Ijaz Sheikh) [#881](https://github.com/nodejs/node/pull/881)
...
* [[`dd37fb4c48`](https://github.com/nodejs/node/commit/dd37fb4c48)] - **build**: eliminar argumento incorrecto en vcbuild.bat (Jeremiah Senkpiel) [#1198](https://github.com/nodejs/node/pull/1198)
...
* [[`69350baaef`](https://github.com/nodejs/node/commit/69350baaef)] - **doc**: actualizar la sección de prueba en CONTRIBUTING.md (Ben Noordhuis) [#1181](https://github.com/nodejs/node/pull/1181)
* [[`3c8ae2d934`](https://github.com/nodejs/node/commit/3c8ae2d934)] - **doc**: añadir a petkaantonov como colaborador (Petka Antonov) [#1179](https://github.com/nodejs/node/pull/1179)
...
* [[`c638dad567`](https://github.com/nodejs/node/commit/c638dad567)] - **benchmark**: añadir la opción de formato de salida \[csv\] (Brendan Ashworth) [#777](https://github.com/nodejs/node/pull/777)
...
* [[`e6e616fdcb`](https://github.com/nodejs/node/commit/e6e616fdcb)] - **doc**: corregir los errores tipográficos en '\\' en Windows (Steven Vercruysse) [joyent/node#9412](https://github.com/joyent/node/pull/9412)
* [[`89bf6c05e9`](https://github.com/nodejs/node/commit/89bf6c05e9)] - **build**: permitir la ruta de PackageMaker personalizada (Julien Gilli) [joyent/node#9377](https://github.com/joyent/node/pull/9377)
...
* [[`4eb8810a27`](https://github.com/nodejs/node/commit/4eb8810a27)] - **tls**: re-habilitar `.writev()` en TLSWrap (Fedor Indutny) [#1155](https://github.com/nodejs/node/pull/1155)
...
* [[`7a5b023bac`](https://github.com/nodejs/node/commit/7a5b023bac)] - **doc**: corregir los ejemplos de módulo de vm (FangDun Cai) [#1147](https://github.com/nodejs/node/pull/1147)
* [[`7bde3f1a8f`](https://github.com/nodejs/node/commit/7bde3f1a8f)] - **(SEMVER-MINOR) src**: añadir banderas -r/--require para módulos de pre-carga (Ali Ijaz Sheikh) [#881](https://github.com/nodejs/node/pull/881)
...
* [[`a6af709489`](https://github.com/nodejs/node/commit/a6af709489)] - **fs**: utilizar stat.st_size sólo para leer archivos regulares (Santiago Gimeno) [#1074](https://github.com/nodejs/node/pull/1074)
* [[`0782c24993`](https://github.com/nodejs/node/commit/0782c24993)] - **test**: corregir la prueba de readfile-zero-byte-liar (Santiago Gimeno) [#1074](https://github.com/nodejs/node/pull/1074)
...
* [[`60dac07b06`](https://github.com/nodejs/node/commit/60dac07b06)] - **doc**: añadir Malte-Thorben Bruns a .mailmap (Ben Noordhuis) [#1118](https://github.com/nodejs/node/pull/1118)
...
* [[`80e14d736e`](https://github.com/nodejs/node/commit/80e14d736e)] - **doc**: mover la opción checkServerIdentity a tls.connect() (skenqbx) [#1107](https://github.com/nodejs/node/pull/1107)
* [[`684a5878b6`](https://github.com/nodejs/node/commit/684a5878b6)] - **doc**: corregir los puntos faltantes en url.markdown (Ryuichi Okumura) [#1115](https://github.com/nodejs/node/pull/1115)
...
* **tls**: Las pérdidas de memoria de TLS reportadas han sido al menos parcialmente resueltas a través de varios commits en este lanzamiento. Las pruebas actuales indicaron que *podrían* todavía haber algunos problemas de pérdida. Rastree el progreso completo en [#1075](https://github.com/nodejs/node/issues/1075).
* **http**: Se corrigió un error reportado en [joyent/node#9348](https://github.com/joyent/node/issues/9348) y en [npm/npm#7349](https://github.com/npm/npm/issues/7349). Los datos pendientes no estaban siendo leídos completamente cuando se producía un evento de `'error'` que conducía a una falla de aserción ante `socket.destroy()`. (Fedor Indutny) [#1103](https://github.com/nodejs/node/pull/1103)
...
* [[`8670613d2d`](https://github.com/nodejs/node/commit/8670613d2d)] - **node_crypto_bio**: ajustar el tamaño de memoria externa (Fedor Indutny) [#1085](https://github.com/nodejs/node/pull/1085)
* [[`528d8786ff`](https://github.com/nodejs/node/commit/528d8786ff)] - **src**: corregir pérdida de memoria en la ruta de error de fs.writeSync (Ben Noordhuis) [#1092](https://github.com/nodejs/node/pull/1092)
...
* **buffer**: Nuevo método `Buffer#indexOf()`, modelado a partir de [`Array#indexOf()`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/indexOf). Acepta una String, un Buffer o un Número. Las strings son interpretadas como UTF8. (Trevor Norris) [#561](https://github.com/nodejs/node/pull/561)
...
* [[`37bb1df7c4`](https://github.com/nodejs/node/commit/37bb1df7c4)] - **build**: eliminar mdb de io.js (Johan Bergström) [#1023](https://github.com/nodejs/node/pull/1023)
* [[`726671cb0e`](https://github.com/nodejs/node/commit/726671cb0e)] - **build**: añadir soporte básico de mips/mipsel (Ben Noordhuis) [#1045](https://github.com/nodejs/node/pull/1045)
...
* [[`6190a2236b`](https://github.com/nodejs/node/commit/6190a2236b)] - **doc**: eliminar a cjihrig del TC (cjihrig) [#1056](https://github.com/nodejs/node/pull/1056)
...
* [[`555a7c48cf`](https://github.com/nodejs/node/commit/555a7c48cf)] - **events**: optimizar la clonación del array listener (Brian White) [#1050](https://github.com/nodejs/node/pull/1050)
* [[`4d0329ebeb`](https://github.com/nodejs/node/commit/4d0329ebeb)] - **(SEMVER-MINOR) fs**: eliminar el uso innecesario de .hasOwnProperty() (Jonathan Ong) [#635](https://github.com/nodejs/node/pull/635)
...
* [[`08133f45c7`](https://github.com/nodejs/node/commit/08133f45c7)] - **http**: optimizar las solicitudes salientes (Brendan Ashworth) [#605](https://github.com/nodejs/node/pull/605)
* [[`dccb69a21a`](https://github.com/nodejs/node/commit/dccb69a21a)] - **js_stream**: corregir las pérdidas de instancias (Fedor Indutny) [#1078](https://github.com/nodejs/node/pull/1078)
...
* [[`8f5f12bb48`](https://github.com/nodejs/node/commit/8f5f12bb48)] - **smalloc**: exportar las constantes desde C++ (Vladimir Kurchatkin) [#920](https://github.com/nodejs/node/pull/920)
...
* [[`c9ee654290`](https://github.com/nodejs/node/commit/c9ee654290)] - **src**: simplificar el node::Utf8Value() (Ben Noordhuis) [#1042](https://github.com/nodejs/node/pull/1042)
* [[`364cc7e08a`](https://github.com/nodejs/node/commit/364cc7e08a)] - **src**: eliminar la variable de entorno NODE_INVALID_UTF8 (Ben Noordhuis) [#1042](https://github.com/nodejs/node/pull/1042)
...
* [[`f5b7e18243`](https://github.com/nodejs/node/commit/f5b7e18243)] - **src**: eliminar código no utilizado (Ben Noordhuis) [#1042](https://github.com/nodejs/node/pull/1042)
...
* [[`b150c9839e`](https://github.com/nodejs/node/commit/b150c9839e)] - **src**: corregir las advertencias del compilador -Wempty-body (Ben Noordhuis) [#974](https://github.com/nodejs/node/pull/974)
* [[`fb284e2e4d`](https://github.com/nodejs/node/commit/fb284e2e4d)] - **src**: corregir la advertencia del compilador en smalloc.cc (Ben Noordhuis) [#1055](https://github.com/nodejs/node/pull/1055)
* [[`583a868bcd`](https://github.com/nodejs/node/commit/583a868bcd)] - **stream_wrap**: añadir HandleScope's en callbacks uv (Fedor Indutny) [#1078](https://github.com/nodejs/node/pull/1078)
...
* [[`7b554b1a8f`](https://github.com/nodejs/node/commit/7b554b1a8f)] - **test**: no generar procesos secundarios en la prueba del dominio (Ben Noordhuis) [#974](https://github.com/nodejs/node/pull/974)
* [[`b72fa03057`](https://github.com/nodejs/node/commit/b72fa03057)] - **test**: añade una prueba para el valor indefinido en setHeader (Ken Perkins) [#970](https://github.com/nodejs/node/pull/970)
...
* [[`c7ad320472`](https://github.com/nodejs/node/commit/c7ad320472)] - **test**: comprobar el cli de openssl y, si existe, proporcionar una ruta (Johan Bergström) [#1049](https://github.com/nodejs/node/pull/1049)
* [[`71776f9057`](https://github.com/nodejs/node/commit/71776f9057)] - **test**: eliminar las importaciones de https no utilizadas (Johan Bergström) [#1049](https://github.com/nodejs/node/pull/1049)
* [[`3d5726c4ad`](https://github.com/nodejs/node/commit/3d5726c4ad)] - **test**: introducir un ayudante que verifique si la criptografía está disponible (Johan Bergström) [#1049](https://github.com/nodejs/node/pull/1049)
* [[`d0e7c359a7`](https://github.com/nodejs/node/commit/d0e7c359a7)] - **test**: no asumir que process.versions.openssl está siempre disponible (Johan Bergström) [#1049](https://github.com/nodejs/node/pull/1049)
* [[`e1bf6709dc`](https://github.com/nodejs/node/commit/e1bf6709dc)] - **test**: corregir racey-ness en tls-inception (Fedor Indutny) [#1040](https://github.com/nodejs/node/pull/1040)
* [[`fd3ea29902`](https://github.com/nodejs/node/commit/fd3ea29902)] - **test**: corregir test-fs-access cuando uid sea 0 (Johan Bergström) [#1037](https://github.com/nodejs/node/pull/1037)
* [[`5abfa930b8`](https://github.com/nodejs/node/commit/5abfa930b8)] - **test**: hacer a destroyed-socket-write2.js más robusto (Michael Dawson) [joyent/node#9270](https://github.com/joyent/node/pull/9270)
...
* [[`bd1bd7e38d`](https://github.com/nodejs/node/commit/bd1bd7e38d)] - **timer**: Mejorar el rendimiento de los callbacks (Ruben Verborgh) [#406](https://github.com/nodejs/node/pull/406)
* [[`7b3b8acfa6`](https://github.com/nodejs/node/commit/7b3b8acfa6)] - **tls**: aceptar `net.Socket`s vacías (Fedor Indutny) [#1046](https://github.com/nodejs/node/pull/1046)
...
* **stream**: Se corrigieron problemas para plataformas sin soporte de `writev()`, particularmente Windows. Los cambios introducidos en 1.4.1, a través de [#926](https://github.com/nodejs/node/pull/926), rompieron algunas funcionalidades para estas plataformas; esto ya ha sido abordado. [#1008](https://github.com/nodejs/node/pull/1008) (Fedor Indutny)
* **arm**: Tenemos los inicios del soporte de ARMv8 / ARM64 / AARCH64. Se requiere una actualización a OpenSSL 1.0.2 para un soporte completo. [#1028](https://github.com/nodejs/node/pull/1028) (Ben Noordhuis)
* Se añadió un nuevo colaborador: Julian Duque ([@julianduque](https://github.com/julianduque))
...
* [[`dfe7a17784`](https://github.com/nodejs/node/commit/dfe7a17784)] - **doc**: corregir los errores tipográficos y fuentes en WORKING_GROUPS.md (&! (bitandbang)) [#1022](https://github.com/nodejs/node/pull/1022)
* [[`6d26990d32`](https://github.com/nodejs/node/commit/6d26990d32)] - **doc**: Limpiar el net.Socket (Ryan Scheel) [#951](https://github.com/nodejs/node/pull/951)
* [[`c380ac6e98`](https://github.com/nodejs/node/commit/c380ac6e98)] - **doc**: sugerir alternativas para APs desaprobadas (Benjamin Gruenbaum) [#1007](https://github.com/nodejs/node/pull/1007)
...
* [[`25da0742ee`](https://github.com/nodejs/node/commit/25da0742ee)] - **build**: mejorar el vcbuild.bat (Bert Belder) [#998](https://github.com/nodejs/node/pull/998)
* [[`b8310cbd3e`](https://github.com/nodejs/node/commit/b8310cbd3e)] - **build**: reducir el tamaño del tarball entre 8-10% (Johan Bergström) [#961](https://github.com/nodejs/node/pull/961)
...
* [[`f83d380647`](https://github.com/nodejs/node/commit/f83d380647)] - **doc**: actualizar el os.markdown (Benjamin Gruenbaum) [#976](https://github.com/nodejs/node/pull/976)
...
* [[`755461219d`](https://github.com/nodejs/node/commit/755461219d)] - **tls**: corregir el error tipográfico `handle._reading` => `handle.reading` (Fedor Indutny) [#994](https://github.com/nodejs/node/pull/994)

<a id="1.4.1"></a>

## 2015-02-26, Versión 1.4.1, @rvagg

*Nota: la versión **1.4.0** fue etiquetada y compilada, pero no hubo lanzamiento. Se descubrió un bug en el proceso, por lo tanto se abortó el lanzamiento. La etiqueta seguía a [`a558cd0a61`](https://github.com/nodejs/node/commit/a558cd0a61), pero ha sido removida. Hemos saltado a 1.4.1 para evitar confusión.*

### Cambios notables

* **process** / **promises**: Un evento `'unhandledRejection'` ahora es emitido en `process` cada vez que se rechaza una `Promise` y no se adjunta ningún manejador de error a la `Promise` dentro de una vuelta del bucle del evento. Ahora se emite un evento `'rejectionHandled'` cada vez que una `Promise` es rechazada y un manejador de error es adjuntada a la misma después de una vuelta del bucle del evento. Vea la documentación del [proceso](https://iojs.org/api/process.html) para más detalles. [#758](https://github.com/nodejs/node/pull/758) (Petka Antonov)
...
* **http**: Un nuevo evento `'abort'` emitido cuando el cliente aborta a `http.ClientRequest`. [#945](https://github.com/nodejs/node/pull/945) (Evan Lucas)
...
* **npm**: Actualización de npm a 2.6.0. Incluye funcionalidades para soportar el nuevo registro y para prepararse para `npm@3`. Vea [npm CHANGELOG.md](https://github.com/npm/npm/blob/master/CHANGELOG.md#v260-2015-02-12) para detalles. Resumen: 
  ...
  * [`7c81a5f`](https://github.com/npm/npm/commit/7c81a5f5f058941f635a92f22641ea68e79b60db) [#7171](https://github.com/npm/npm/issues/7171) Advertir que `engineStrict` en `package.json` se irá en la siguiente gran versión de npm (¡próximamente!) ([@othiym23](https://github.com/othiym23))
* **libuv**: Actualización a 1.4.2. Vea el [ChangeLog de libuv](https://github.com/libuv/libuv/blob/v1.x/ChangeLog) para detalles de las correcciones.
...
* [[`234e6916b8`](https://github.com/nodejs/node/commit/234e6916b8)] - **build**: Corregir la referencia incorrecta (Johan Bergström) [#924](https://github.com/nodejs/node/pull/924)
...
* [[`b65dade102`](https://github.com/nodejs/node/commit/b65dade102)] - **doc**: actualizar la documentation.markdown para io.js. (Ryan Scheel) [#950](https://github.com/nodejs/node/pull/950)
...
* [[`872702d9b7`](https://github.com/nodejs/node/commit/872702d9b7)] - **(SEMVER-MINOR) node**: implementar el seguimiento de rechazo no manejado (Petka Antonov) [#758](https://github.com/nodejs/node/pull/758)
...
* [[`ed3b057e9f`](https://github.com/nodejs/node/commit/ed3b057e9f)] - **util**: manejar los símbolos apropiadamente en format() (cjihrig) [#931](https://github.com/nodejs/node/pull/931)
...
* [[`0555b3c785`](https://github.com/nodejs/node/commit/0555b3c785)] - **doc**: corregir el error tipográfico miliseconds -> milliseconds (jigsaw) [#865](https://github.com/nodejs/node/pull/865)
* [[`fc6507dd4e`](https://github.com/nodejs/node/commit/fc6507dd4e)] - **doc**: añadir coma en README para mejorar la claridad (Jimmy Hsu)
* [[`f0296933f8`](https://github.com/nodejs/node/commit/f0296933f8)] - **doc**: corregir `it's` por `its` en "process"(Charmander) [#837](https://github.com/nodejs/node/pull/837)
...
* [[`c3c2fbdf83`](https://github.com/nodejs/node/commit/c3c2fbdf83)] - **doc**: cambiar el efecto para que afecte en errors.md (Ryan Seys) [#799](https://github.com/nodejs/node/pull/799)
...
* [[`e80f803298`](https://github.com/nodejs/node/commit/e80f803298)] - **doc**: eliminar la sección de Caine de la guía de contribución (Michaël Zasso) [#804](https://github.com/nodejs/node/pull/804)
* [[`400d6e56f9`](https://github.com/nodejs/node/commit/400d6e56f9)] - **doc**: corregir el link de libuv (Yosuke Furukawa) [#803](https://github.com/nodejs/node/pull/803)
* [[`15d156e3ec`](https://github.com/nodejs/node/commit/15d156e3ec)] - **doc**: corregir la redacción en fs.appendFile (Rudolf Meijering) [#801](https://github.com/nodejs/node/pull/801)
* [[`dbf75924f1`](https://github.com/nodejs/node/commit/dbf75924f1)] - **doc**: actualizar los enlaces de error (Chris Dickinson) [#793](https://github.com/nodejs/node/pull/793)
* [[`7061669dba`](https://github.com/nodejs/node/commit/7061669dba)] - **events**: optimizar la adición y eliminación de listeners (Brian White) [#785](https://github.com/nodejs/node/pull/785)
* [[`630f636334`](https://github.com/nodejs/node/commit/630f636334)] - **events**: eliminar la ruta lenta para también separar la función (Brian White) [#785](https://github.com/nodejs/node/pull/785)
* [[`ecef87177a`](https://github.com/nodejs/node/commit/ecef87177a)] - **fs**: asegurarse de que el callback nullCheck() es una función (cjihrig) [#887](https://github.com/nodejs/node/pull/887)
* [[`6a2b204bbc`](https://github.com/nodejs/node/commit/6a2b204bbc)] - **module**: remplazar NativeModule.require (Herbert Vojčík) [joyent/node#9201](https://github.com/joyent/node/pull/9201)
...
* [[`a956791f69`](https://github.com/nodejs/node/commit/a956791f69)] - **src**: corregir error tipográfico en el mensaje de error (Ben Noordhuis) [#875](https://github.com/nodejs/node/pull/875)
...
* [[`7e779b4593`](https://github.com/nodejs/node/commit/7e779b4593)] - **src**: eliminar la cabecera queue.h obsoleta (Ben Noordhuis) [#667](https://github.com/nodejs/node/pull/667)
* [[`38dc0cd8f4`](https://github.com/nodejs/node/commit/38dc0cd8f4)] - **src**: cambiar de QUEUE a la lista intrusiva (Ben Noordhuis) [#667](https://github.com/nodejs/node/pull/667)
...
* [[`d53b636d94`](https://github.com/nodejs/node/commit/d53b636d94)] - **test**: verificar los campos en los errores de spawn{Sync} errors (cjihrig) [#838](https://github.com/nodejs/node/pull/838)
* [[`3b1b4de903`](https://github.com/nodejs/node/commit/3b1b4de903)] - **test**: Timeout#unref() no devuelve la instancia (Jan Schär) [joyent/node#9171](https://github.com/joyent/node/pull/9171)
...
* [[`faa687b4be`](https://github.com/nodejs/node/commit/faa687b4be)] - **url**: resolver las urls con . y .. (Amir Saboury) [#278](https://github.com/nodejs/node/pull/278)
...
* **dns**: 
  * `lookup()` ahora tiene soporte de la opción booleana `'all'`, se predetermina a `false`, pero cuando se activa causa que el método devuelva un array de *todos* los nombres resueltos por una dirección, vea [#744](https://github.com/nodejs/node/pull/744) (@silverwind)
* **assert**: 
  * Eliminar la comparación de propiedad de `prototype` en `deepEqual()`, es considerada una corrección, vea [#636](https://github.com/nodejs/node/pull/636) (@vkurchatkin)
...
* **tracing**: 
  * Añadir [LTTng](http://lttng.org/) (Linux Trace Toolkit Next Generation) cuando se compila con la opción `--with-lttng`. Los puntos de seguimiento coinciden con aquellos disponibles para DTrace y ETW. [#702](https://github.com/nodejs/node/pull/702) (@thekemkid)
* **docs**: 
...
* [[`7e2235a`](https://github.com/nodejs/node/commit/7e2235aebb067b84974e001f9fa4d83f45b7c9dd)] - doc: añadir documentación de error (Chris Dickinson)
...
* [[`90d2b35`](https://github.com/nodejs/node/commit/90d2b352810bc352620e61e0dacc8573faf11dfb)] - doc: actualizar la salida anticuada de process.versions (Ben Noordhuis)
...
* [[`1cd1d7a`](https://github.com/nodejs/node/commit/1cd1d7a182c2d16c28c778ddcd72bbeac6bc5c75)] - buffer: no comparar los mismos buffers (Vladimir Kurchatkin)
...
* [[`7a301e2`](https://github.com/nodejs/node/commit/7a301e29de1e4ab5f39165beb6d0b41435c221dd)] - deps: hacer que node-gyp funcione otra vez en windows (Bert Belder)
...
* [[`e7573f9`](https://github.com/nodejs/node/commit/e7573f9111f6b85c599ec225714d76e08ec8a4dc)] - assert: no comparar la propiedad de `prototype` de objeto (Vladimir Kurchatkin)
...
* [[`62512bb`](https://github.com/nodejs/node/commit/62512bb29cd000dd5ce848258c10f3211f153bd5)] - test: aceptar el error ipv6 de EPROTONOSUPPORT (Ben Noordhuis)
...
* [[`10277d2`](https://github.com/nodejs/node/commit/10277d2e57ee7fe9e0e3f63f10b9ea521e86e7f0)] - docs: incluir la mención de nuevos métodos criptográficos (Calvin Metcalf)
* [[`9a8f186`](https://github.com/nodejs/node/commit/9a8f18613da4956c963377e2ad55cdd3dabc32aa)] - child_process: añadir detalles de depuración y error (Zach Bruggeman)
...
* [[`e0730ee`](https://github.com/nodejs/node/commit/e0730eeaa5231841a7eba080c8170e41278c3c52)] - benchmark: permitir la comparación a través de filtros de fine-grained (Brian White)
...
* debug: corregir depuración post-mortem de v8.
...
* crypto: se añadieron funciones de privateEncrypt/publicDecrypt.
* errores 
  * mejor formato a través de util.inspect
  * errores del fs más descriptivos. Esto requería que se actualizara la `NODE_MODULE_VERSION`.
  * errores de http.setHeader más descriptivos
* actualizaciones de dependencias: 
  * npm: actualización a 2.4.1
  * http-parser: regresar a 2.3.0
  * libuv: actualización a 1.3.0
  * v8: actualización a 4.1.0.14
...
* [[`8b88ff8`](https://github.com/nodejs/node/commit/8b88ff85f106eed03bf677b9ab3b842f4edbdc6b)] - deps: corregir el soporte de postmortem en v8 (Fedor Indutny)
...
* [[`bce7a26`](https://github.com/nodejs/node/commit/bce7a2608eb198eee6ecd7991062efd6daeeb440)] - deps: hacer que make node-gyp funcione otra vez en windows (Bert Belder)
...
* [[`bc2c85c`](https://github.com/nodejs/node/commit/bc2c85ceef7ac034830e4a4357d0aef69cd6e386)] - fs: mejorar los mensajes de error (Bert Belder)
...
* [[`e17e6fb`](https://github.com/nodejs/node/commit/e17e6fb2faa04193eddf8062fbd49f1612b4dbff)] - util: utilizar el buffer on-stack para Utf8Value (Fedor Indutny)
...
* [[`45d8d9f`](https://github.com/nodejs/node/commit/45d8d9f8262983d7d6434f4500b4e88b63052cd5)] - buffer: implementar la interfaz `iterable` (Vladimir Kurchatkin)
* [[`3cbb5cd`](https://github.com/nodejs/node/commit/3cbb5cdfdb621baec5dc3a2ac505be37f1718086)] - console: aceptar los campos de Object.prototype como etiquetas (cjihrig)
...
* [[`497fd72`](https://github.com/nodejs/node/commit/497fd72e21d2d1216e8457928d1a8082349fd0e5)] - fs: corregir la pérdida de fd en ReadStream.destroy() (Alex Kocharin)
* [[`8b09ae7`](https://github.com/nodejs/node/commit/8b09ae76f1d854a0db579fc0737df4809ce6087d)] - doc: añadir enlaces para mejoras de http_parser/libuv (Michael Hart)
...
* [[`1855267`](https://github.com/nodejs/node/commit/18552677d7e4468b093f28e721d1c02ce001b558)] - doc: corregir el pequeño error gramatical en los documentos de streams (ttrfwork)
...
* [[`301a968`](https://github.com/nodejs/node/commit/301a968a40152c1ad3562482b4044458a13ebc4f)] - child_process: eliminar la condición redundante (Vladimir Kurchatkin)
* [[`06cfff9`](https://github.com/nodejs/node/commit/06cfff935012ed2826cac56284cea982630cbc27)] - http: no se moleste en realizar una copia de las opciones (Jonathan Ong)
...
* [[`50ac4b7`](https://github.com/nodejs/node/commit/50ac4b7e2a823f92f0e102b804ec73f00eacb216)] - Trabajando en 1.0.5 (Rod Vagg)
...
* [[`73ddaa6`](https://github.com/nodejs/node/commit/73ddaa629c145af1632ac67d5d7d3a2abeabdf24)] - tools: eliminar el viejo script de updateAuthors.awk (Rod Vagg)
...
* [[`33186fa`](https://github.com/nodejs/node/commit/33186fa7d89aef988e5cf24801de891d325afd7d)] - doc: añade a brendanashworth como colaborador (Brendan Ashworth)
...
* [[`df0d790`](https://github.com/nodejs/node/commit/df0d790107edf635dc233f3338b3c2e68db58cc7)] - doc: dns.lookupService tiene el nivel de encabezado erróneo (Icer Liang)
* [[`8b1db9c`](https://github.com/nodejs/node/commit/8b1db9c0a7dc39261218a0fac2dd6cf4fbb6a7b4)] - doc: nota en los documentos acerca de las interfaces faltantes (Todd Kennedy)
...
* [[`e5e5980`](https://github.com/nodejs/node/commit/e5e598060eb43faf2142184d523a04f0ca2d95c3)] - lib,src: hacer a pseudoRandomBytes un alias de randomBytes (Calvin Metcalf)
* [[`c6cd460`](https://github.com/nodejs/node/commit/c6cd46041c70794d89634da380555fb613c2e0ab)] - configure: eliminar la variable arm_neon no utilizada (Ben Noordhuis)
* [[`7d9d756`](https://github.com/nodejs/node/commit/7d9d7560cfbd24172ede690e74cedbb4b26e32c9)] - configure: deshabilitar a vfpv3 en armv6 (Ben Noordhuis)
...
* La actualización de 3.31 a 4.1, no es una gran actualización, el número de versión "4.1" significa el seguimiento hacia Chrome 41. La rama 3.31 no se está dirigiendo ahora hacia una versión estable.
* Volver a habilitar el soporte de Windows XP / 2003
* actualización de npm a 2.2.0
* Soporte de FreeBSD mejorado
...
* [[`9419e1f`](https://github.com/nodejs/node/commit/9419e1fb698e1a9319fec5c4777686d62fad4a51)] - src: corregir la inconsistencia entre una verificación y un error (toastynerd)
...
* [[`e2558f0`](https://github.com/nodejs/node/commit/e2558f02dfb671fc74f5768d4401a826efb5c117)] - net: corregir los detalles de error en connect() (cjihrig)
* [[`4af5746`](https://github.com/nodejs/node/commit/4af5746993a6b91c88973b6debcee19c6cd35185)] - win,build: eliminar la definición duplicada (Bert Belder)
* [[`e8d0850`](https://github.com/nodejs/node/commit/e8d08503c7821e8c92e9fa236ed7328e9bdfe62a)] - win: traer de vuelta el soporte de xp/2k3 (Bert Belder)
...
* [[`2253d30`](https://github.com/nodejs/node/commit/2253d30d9cbba42abc1faa183e4480cac69c4222)] - build: eliminar la variable no utilizada (Johan Bergström)
...
* [[`6f36630`](https://github.com/nodejs/node/commit/6f36630f55efcbe5954a52ac22bbb0a378020e98)] - doc: corregir los ejemplos de util.isBuffer (Thomas Jensen)
...
* [[`e8ad773`](https://github.com/nodejs/node/commit/e8ad773b56a94fad2cd8a454453a7214a8ce92d1)] - src: eliminar --noharmony_classes otra vez (Ben Noordhuis)
...
* [[`4764eef`](https://github.com/nodejs/node/commit/4764eef9b2efdf17cafeb4ec40898c6669a84e3b)] - doc: puntuación corregida (Brenard Cubacub)
...
* [[`6242229`](https://github.com/nodejs/node/commit/62422297f52523d2214136cd5514e2453197e3e8)] - tools: añadir el módulo de python-gflags (Shigeki Ohtsu)
...
* [[`265cb76`](https://github.com/nodejs/node/commit/265cb76517d81408afb72506c778f0c0b889f4dc)] - build: añadir una nueva configuración del instalador para OS X (Rod Vagg)
...
* [[`9b81c3e`](https://github.com/nodejs/node/commit/9b81c3e77ffd733645956129a38fdc2fddd08b50)] - doc: corregir la atribución del autor (Tom Hughes)
* [[`fd30eb2`](https://github.com/nodejs/node/commit/fd30eb21526bdaa5aabb15523b0a766e0cbbe535)] - src: corregir los errores de jslint (Yosuke Furukawa)
...
* [[`753fcaa`](https://github.com/nodejs/node/commit/753fcaa27066b34a99ee1c02b43a32744fc92a3c)] - doc: extender el ejemplo de http.request para el fin del evento (Michal Tehnik)
* [[`8440cac`](https://github.com/nodejs/node/commit/8440cacb100ae83c2b2c02e82a87c73a66380c21)] - src: corregir la url de documentación en el mensaje de ayuda (Shigeki Ohtsu)
* [[`24def66`](https://github.com/nodejs/node/commit/24def662936ae8c15770ede0344cd7a7402a63ef)] - win,msi: advertir que el io.js viejo necesita desinstalación manual (Bert Belder)
...
* doc: mejorar la consistencia del estilo de escritura (Rui Marinho)
* win,msi: corregir el enlace del sitio web del documento (Bert Belder)
...
* Se añadieron los métodos `buf.writeUIntLE`, `buf.writeUIntBE`, `buf.writeIntLE`, `buf.writeIntBE`, `buf.readUIntLE`, `buf.readUIntBE`, `buf.readIntLE` y `buf.readIntBE` que leen y escriben valores de hasta 6 bytes.
* Fue añadido `Buffer.compare()`, el cual realiza `memcmp()` sobre dos instancias de Búfer. Las mismas instancias también tienen un `compare()`.
* Se añadió `buffer.equals()`, el cual verifica la igualdad de Buffers por sus contenidos.
* Se añadió un constructor de `new Buffer(otherBuffer)`.
* Semánticas de `SlowBuffer` mejoradas.
* Se actualizó la salida de `buffer.toJSON()` para que no fuera la misma que un array. En su lugar, es un objeto específicamente etiquetado como un buffer, el cual puede ser recuperado al pasarlo al (una nueva sobrecarga de) constructor del `Buffer`.

### child_process

https://iojs.org/api/child_process.html

* Se añadió una opción de `shell` a `child_process.exec`.
* Se añadieron contrapartes sincrónicas a las funciones del proceso secundario: `child_process.spawnSync`, `child_process.execSync` y `child_process.execFileSync`.
* Se añadió la ruta a cualquier error de `ENOENT`, para una depuración más sencilla.

### console

https://iojs.org/api/console.html

* Se añadió un parámetro de `options` a `console.dir`.

### cluster

https://iojs.org/api/cluster.html

* Se actualizó `cluster` para que utilice un balance de carga de tipo round-robin, por defecto, en plataformas distintas a Windows. Sin embargo, la política de programación es configurable.
...
* Se añadió `hostname` en los mensajes de error cuando esté disponible.
* Se mejoró la consistencia en el manejo de errores.

### events

https://iojs.org/api/events.html

* Se añadió soporte de cadena a `EventEmitter.setMaxListeners`.
...
* Se añadió `fs.access` y se desaprobó a `fs.exists`. Por favor lea la documentación cuidadosamente.
...
* Se corrigió que los errores de callbacks perdidas sólo fueran impresas en lugar de arrojadas.

### http

https://iojs.org/api/http.html

* Se añadió soporte para `response.write` y `response.end` para que reciban un callback para saber cuando la operación se complete.
* Se añadió soporte para el código de estado 308 (vea RFC 7238).
* Se añadió el array `http.METHODS`, en donde se enlistan los métodos HTTP soportados por el analizador.
...
* Se añadió el comportamiento Keep-Alive del Cliente. Se estableció `keepAlive:true` en las opciones de solicitud para que reutilice las conexiones indefinidamente.
* Se añadieron los miembros `rawHeaders` y `rawTrailers` en el mensaje entrante.
...
* Se añadieron direcciones MAC, netmasks e IDs de ámbito para direcciones IPv6 para el output del método `os.networkInterfaces`.
...
* Se añadieron los objetos `path.win32` y `path.posix` que contienen versiones de plataforma específica de las diversas funciones de `path`.
* Se mejoró el rendimiento de `path.join`.
...
* Se eliminó `process.maxTickDepth`, lo que le permite que `process.nextTick` sea utilizado recursivamente sin límite.
* Se actualizó a `setImmediate` para que procese toda la cola en cada turno del bucle del evento, en lugar de uno por cola.

### tls

https://iojs.org/api/tls.html

* Se añadió la bandera booleana `detailed` a `getPeerCertificate` para que devuelva información certificada detallada (con bytes DER raw).
* Se añadió el método `renegotiate(options, callback)` para la renegociación de la sesión.
* Se añadió el método `setMaxSendFragment` para la variación del tamaño del fragmento TLS.
* Se añadió la opción `dhparam` para cifrados DH.
* Se añadió una opción `ticketKeys` para la configuración de las claves de encriptado del ticket de TLS.
* Se añadió el callback OCSP-stapling asincrónico.
* Se añadieron los eventos de almacenamiento de sesión asincrónicos.
* Se añadió el callback SNI asincrónico.
* Se añadió soporte de servidor de múltiples claves (por ejemplo, el servidor ECDSA+RSA).
...
* Se implementaron streams TLS en C++, potenciando su rendimiento.
* Se movió `createCredentials` a `tls` y se renombró como `createSecureContext`.
* Se eliminó el soporte de SSLv3 y SSLv3.

### url

https://iojs.org/api/url.html

* Se mejoró el escape de ciertos caracteres.
...
* Se actualizó `util.format` para que recibiera varios cambios: 
  * `-0` ahora se muestra como tal, en lugar de `0`.
  * Todo aquello que es un `instanceof Error` ahora tiene formato de error.
  * Las referencias circulares en los objetos de JavaScript ahora son manejados por el especificador `%j`.
  * Ahora se les permite a las funciones `inspect` personalizadas que devuelvan un objeto.
  * Las funciones `inspect` personalizadas ahora reciben cualquier argumento pasado a `util.inspect`.

## v8

https://iojs.org/api/v8.html

`v8` es un nuevo módulo core para interconectar directamente con el motor V8.

### vm

https://iojs.org/api/vm.html

Se reescribió el módulo `vm` para que funcione mejor, basándose en el excelente módulo nativo de [Contextualizar](https://github.com/brianmcd/contextify). Toda la funcionalidad de Contextify se encuentra ahora en el núcleo, ¡con mejoras!

* Se añadió el método `vm.isContext(object)` para determinar si el `object` ha sido contextualizado.
* Se añadió el método `vm.runInDebugContext(code)` para compilar y ejecutar el `code` dentro del contexto de depuración de V8.
...
* Se actualizaron la mayoría de los métodos `vm` y `vm.Script` para que acepten un objeto `options`, lo que le permite configurar un tiempo de espera para el script, el comportamiento de visualización de error, y en algunas ocasiones el nombre del archivo (para stack traces).
...
Para mayor información, vea la documentación de `vm` enlazada arriba.
...
* Se añadieron versiones sincrónicas de los métodos zlib.

### Cambios de la API de C++

https://iojs.org/api/addons.html

En general, se recomienda que utilice [NAN](https://github.com/rvagg/nan) como una capa de compatibilidad para sus addons. Esto también ayudará con futuros cambios en el API de V8 y Node/io.js C++. La mayor parte de los cambios listados a continuación ya son manejados por envoltorios específicos de NAN.

#### Destacados de V8

* La firma del método expuesto ha sido cambiada de `Handle&lt;Value&gt; Method(const Arguments& args)` a `void Method(const v8::FunctionCallbackInfo&lt;Value&gt;& args)` con el recientemente introducido `FunctionCallbackInfo` tomando también el valor de devolución a través de `args.GetReturnValue().Set(value)` en lugar de `scope.Close(value)`, `Arguments` ha sido eliminado.
...
* Los objetos de V8 instanciados en C++ ahora requieren un argumento de `Isolate*` como el primer argumento. En la mayoría de los casos está bien simplemente pasar `v8::Isolate::GetCurrent()`, p. ej., `Date::New(Isolate::GetCurrent(), time)` o `String::NewFromUtf8(Isolate::GetCurrent(), "foobar")`.
* `HandleScope scope` ahora requiere un argumento de `Isolate*`, es decir, `HandleScope scope(isolate)`, en la mayoría de los casos `v8::Isolate::GetCurrent()` está bien.
* Se han realizado cambios similares a `Locker` y `Unlocker`.
...
* `String::NewSymbol()` ha sido eliminado, utilice strings simples en su lugar.
* `String::New()` ha sido eliminado, utilice `String::NewFromUtf8()` en su lugar.
* Los objetos `Persistent` ya no son heredados desde `Handle` y no pueden ser instanciados con otro objeto. En su lugar, el `Persistent` debe simplemente ser declarado, p. ej., `Persistent&lt;Type&gt; handle` y luego tener un `Local` asignado a él con `handle.Reset(isolate, value)`. Para obtener un `Local` desde un `Persistent`, debe instanciarlo como el argumento, por ejemplo, `Local::New(Isolate*, Persistent)`.

#### Node / io.js

* Se actualizó `node::Buffer::New()` para que devuelva un `Handle` directamente, así ya no necesita buscar la propiedad `handle_`.
* Se actualizó `node::MakeCallback()` para que requiera un `Isolate*` como primer argumento. Generalmente `Isolate::GetCurrent()` estará bien para esto.