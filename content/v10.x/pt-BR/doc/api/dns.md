...
* `options` {integer | Object} 
  * `family` {integer} a família registro. Deve ser `4` ou `6`. IPv4 and IPv6 addresses are both returned by default.
