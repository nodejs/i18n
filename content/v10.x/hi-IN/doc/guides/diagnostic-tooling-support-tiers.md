...
## Not yet classified
 ...
 | डीबगर     | V8 Debug protocol (API)   | No                            | Yes                     | 1           |
 | डीबगर     | Command line Debug Client | ?                             | Yes                     | 1           |
 | डीबगर     | llnode                    | ?                             | No                      | 2           |
 | डीबगर     | Chrome Dev tools          | ?                             | No                      | 3           |
 | डीबगर     | Chakracore - time-travel  | No                            | Data source only        | too early   |
