...
By default set to `Infinity`. Determines how many concurrent sockets the agent can have open per origin. L'origine è il valore restituito di [`agent.getName()`][].
