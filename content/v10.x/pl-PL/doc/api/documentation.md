...
> Stabilność: 1 - Eksperymentalne. This feature is still under active development and subject to non-backward compatible changes or removal in any future version. Korzystanie z tej funkcji nie jest zalecane w środowiskach produkcyjnych. Experimental features are not subject to the Node.js Semantic Versioning model.
