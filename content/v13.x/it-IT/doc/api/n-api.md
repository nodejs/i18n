...
* `[out] result`: Un `napi_value` che rappresenta un array di valori JavaScript che indicano i nomi delle proprietà dell'object. [`napi_get_array_length`][] and [`napi_get_element`][] can be used to iterate over `result`.
