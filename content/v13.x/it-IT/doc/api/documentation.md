...
> Stability: 1 - Experimental. The feature is not subject to Semantic Versioning rules. Non-backward compatible changes or removal may occur in any future release. L'utilizzo di questa funzionalità non è raccomandato negli ambienti di produzione.

<!-- separator -->

> Stabilità: 2 - Stabile. Compatibility with the npm ecosystem is a high priority.
