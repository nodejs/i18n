...
Pruebas para igualdad progunda entre los paŕametros `actual` y `expected`. Consider using [`assert.deepStrictEqual()`][] instead. [`assert.deepEqual()`][] can have surprising results.
