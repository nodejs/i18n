...
للبدء، ستحتاج إلى تثبيت `git` محليًا. Depending on your operating system, there are also a number of other dependencies required. ستجدها مفصلة في [إرشادات البناء](../../../BUILDING.md).
