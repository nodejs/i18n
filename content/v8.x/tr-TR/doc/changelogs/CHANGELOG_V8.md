...
This is a security release. Tüm Node.js kullanıcıları, yamalı güvenlik açıkları hakkında ayrıntılı bilgi için https://nodejs.org/en/blog/vulnerability/march-2018-security-releases/ adresindeki güvenlik açıklaması özetine bakmalıdır.
