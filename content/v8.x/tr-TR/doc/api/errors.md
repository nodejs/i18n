...
- Aşağıdakiler gibi standart JavaScript hataları:
...
Karşılaştırmada hata olduğunu gösteren bir `Error` alt sınıfıdır. Such errors commonly indicate inequality of actual and expected value.
...
An attempt was made to launch a Node.js process with an unknown `stdin` file type. Bu hata genellikle kullanıcı kodunun tetiklemesi mümkün olsa da, Node.js'in kendisinde bir hata olduğunu gösterir.

<a id="ERR_UNKNOWN_STREAM_TYPE"></a>

### ERR_UNKNOWN_STREAM_TYPE

An attempt was made to launch a Node.js process with an unknown `stdout` or `stderr` file type. Bu hata genellikle kullanıcı kodunun tetiklemesi mümkün olsa da, Node.js'in kendisinde bir hata olduğunu gösterir.
