...
- Javascript σφάλματα όπως:
  - {EvalError}: προκαλούνται όταν αποτυγχάνει η εκτέλεση της συνάρτησης `eval()`.
  - {SyntaxError}: προκαλούνται από λανθασμένη σύνταξη των εντολών Javascript.
  - {RangeError}: προκαλούνται όταν μία τιμή είναι εκτός του αναμενόμενου πεδίου τιμών.
  - {ReferenceError}: προκαλούνται με τη χρήση μεταβλητών, που δεν έχουν ορισθεί νωρίτερα.
  - {TypeError}: προκαλούνται όταν μεταφέρονται σε μία συνάρτηση ορίσματα λάθος τύπου.
...
Ο μηχανισμός της Javascript `try / catch` **δεν μπορεί** να χρησιμοποιηθεί για τη διαχείριση σφάλματςν που προκαλούνται από ασύγχρονα APIs. A common mistake for beginners is to try to use `throw` inside an error-first callback:
...
## Exceptions vs. Σφάλματα<!--type=misc-->A JavaScript exception is a value that is thrown as a result of an invalid operation or as the target of a `throw` statement. While it is not required that these values are instances of `Error` or classes which inherit from `Error`, all exceptions thrown by Node.js or the JavaScript runtime *will* be instances of Error.
