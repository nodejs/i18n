...
[`Map`][] và [`Set`][] là có ngoại lệ. Maps and Sets have their contained items compared too, as expected.
...
Xác nhận hàm `block` không gửi đi kết quả lỗi. Tham khảo thêm [`assert.throws()`][].
