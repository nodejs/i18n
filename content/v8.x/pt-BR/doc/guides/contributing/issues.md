...
* [Como contribuir em problemas](#how-to-contribute-in-issues)
* [Pedindo ajuda geral](#asking-for-general-help)
* [Discutir tópicos não técnicos](#discussing-non-technical-topics)
* [Enviando um relatório de erro](#submitting-a-bug-report)
* [Fazendo a triagem de um relatório de erro](#triaging-a-bug-report)
* [Resolvendo um relatório de erro](#resolving-a-bug-report)

## Como contribuir em problemas

Para qualquer problema, existem fundamentalmente três maneiras que alguém pode contribuir:

1. Ao abrir o problema para discussão: por exemplo, se você acredita que você descobriu um bug no Node.js, criando um novo problema no `nodejs/node` na área de "problemas" é a maneira de reportá-lo.
...
## Fazendo a triagem de um relatório de erro
