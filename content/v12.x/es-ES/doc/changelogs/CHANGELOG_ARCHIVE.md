...
* OpenSSL support. Aún sin documentación (ver pruebas). (Rhys Jones)
...
* Include lib/ directory in node executable. Compilar bajo demanda.
...
* API: Many namespacing changes
  ...
  * process is no longer the global object. GLOBAL es.
...
* Feature: global 'process' object. Emite "exit".
...
* Fix http benchmark. No estaba haciendo envíos de manera correcta.
