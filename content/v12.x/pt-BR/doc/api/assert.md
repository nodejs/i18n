...
Testes para uma profunda igualdade entre os parâmetros `actual` e `expected`. Consider using [`assert.deepStrictEqual()`][] instead. [`assert.deepEqual()`][] can have potentially surprising results.
